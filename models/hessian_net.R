#' Hessian network module predicting lower-triangular entries in [-1, 1]
#'
#' @export
hessian_net_lower = nn_module(
  "hessian_net_lower",
  ...
  initialize = function(p,
    ...
    num_lower = k_minus_1 * (k_minus_1 + 1) / 2
    self$num_lower = num_lower
    
    self$head = nn_linear(in_dim, num_lower)
